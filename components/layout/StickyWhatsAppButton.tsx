...
export const StickyWhatsAppButton: React.FC = () => {
  ...
  const defaultMessage = process.env.NEXT_PUBLIC_WHATSAPP_MESSAGE || 'שלום, אני מעוניין במידע על שירותי שיניים';
  
  const whatsappUrl = whatsappPhone
    ? `https://wa.me/${whatsappPhone.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(defaultMessage)}`
    : '#';
