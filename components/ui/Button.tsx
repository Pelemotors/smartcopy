...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    primary: 'bg-gradient-to-r from-primary-dark via-primary to-primary-bright text-white hover:from-primary hover:to-primary-light focus:ring-primary hover:scale-[1.03] active:scale-[0.97] shadow-lg hover:shadow-xl transition-all duration-300',
